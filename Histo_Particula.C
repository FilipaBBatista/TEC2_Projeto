void Histo_Particula(){

//ler ficheiro
TFile *ficheiro = new TFile("AmberTarget_Run_0.root", "READ");
//criar ficheiro
TFile *ficheiroGravar = new TFile("Histogramas_PorParticula.root", "RECREATE");
...
for (Int_t i=0;i<nHistos;i++){
	TString histoName="EdepDet"+TString::Itoa(i,10);
